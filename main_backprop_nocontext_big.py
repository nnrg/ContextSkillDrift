...
class BigNoContextModel(nn.Module):
    def __init__(self, skill_size=96, decision_size=20):
        super().__init__()
...
if __name__ == "__main__":
    ...
    data_folder = f"output/nocontext_big_short_harddecay{trial}"
    try:
